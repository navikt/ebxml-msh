...
export DB_USER_NAME="$DB_EBMS_USERNAME"
export DB_USER_PASS="$DB_EBMS_PASSWORD"
export DB_HOST_NAME="$DB_EBMS_HOST"
export DB_HOST_PORT="$DB_EBMS_PORT"
export DB_NAME="$DB_EBMS_DATABASE"
