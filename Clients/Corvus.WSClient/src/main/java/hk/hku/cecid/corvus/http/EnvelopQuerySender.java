...
public class EnvelopQuerySender extends HttpSender {
     ...
     */
    protected EnvelopQuerySender(Data d) {
        super(d);
    }
     ...
     * @throws NullPointerException     When {@link #getMessageIdToDownload()} return null.<br/>
     *                                  When {@link #getMessageBoxToDownload()} return empty or null.
     * @throws IllegalArgumentException When {@link #getMessageBoxToDownload()} return string not equal to 'INBOX' and 'OUTBOX'
     */
    ...
    protected void onStart() {
        ...
        log.info("Envelop Query HTTP Client init at " + new Date().toString());
        log.info("");
        log.info("Sending Envelop Query HTTP Request with following configuration");
        log.info("------------------------------------------------------------------");
        if (data != null)
